 ...
 * project.
 */
public class Peanut4Encoder extends IterativeRobot {
  ...
  public static final double kDistancePerRevolution = 18.4;
  ...
  public void autonomousPeriodic() {
      ...
      } while (getAverageEncoderPosition() < 1.0);
      m_drive.arcadeDrive(0.0, 0.0);

   /* if (timer.get() < 2.0) {
      m_drive.curvatureDrive(0.3, 0.0, false);
    }
    else
    {
  ...
  private double getAverageEncoderPosition() {
      return (leftFrontEncoder.getDistance() +
              ...
              rightRearEncoder.getDistance()) / 4;
  }
